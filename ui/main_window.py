...
class JanelaEntrada(JanelaBase):
    def __init__(self, carregar_status_vagas_callback):
        ...
        # Será preenchido dinamicamente
        # ComboBox para Seleção de Tempo de Estacionamento (nova adição)
        data_hora_label = QLabel("Tempo de Estacionamento:")
        self.tempo_estacionamento_combobox = QComboBox()
        # Adiciona as opções de tempo que o usuário pode escolher
        self.tempo_estacionamento_combobox.addItems(["3 horas", "12 horas", "Ilimitado"])
        ...
        right_layout.addWidget(self.tempo_estacionamento_combobox)  # Adiciona o ComboBox de tempo ao layout
    ...
    def registrar_estacionamento(self):
        ...
        tempo_estacionamento = self.tempo_estacionamento_combobox.currentText()  # Ex: "3 horas", "12 horas", "Ilimitado"
        ...
        try:
            ...
            self.db.estacionar(vaga_id[0][0], cliente_veiculo_id,tempo_limite=tempo_estacionamento)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.vagas_table = QTableWidget(0, 7)
        self.vagas_table.setHorizontalHeaderLabels(["Vaga", "Status", "Placa", "Cliente", "Horário de Entrada","Tempo", "Tempo Limite"])
        ...
        header.setSectionResizeMode(6, QHeaderView.Stretch)  # Coluna "Tempo Limite"
    ...
    def carregar_status_vagas(self):
        ...
        try:
            ...
            for vaga in vagas:
                ...
                self.vagas_table.setItem(row_position, 6, QTableWidgetItem(vaga[5]))  # Tempo Limite
